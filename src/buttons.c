...
static void btn_func_pressed(const struct device *dev, struct gpio_callback *cb, uint32_t pins)
{
	btn_func_handle("White left", dev, pins, buttons.white_left.pin, 1);
	btn_func_handle("White right", dev, pins, buttons.white_right.pin, 2);
	btn_func_handle("Yellow", dev, pins, buttons.yellow.pin, 3);
	btn_func_handle("Black", dev, pins, buttons.black.pin, 4);
	btn_func_handle("Green", dev, pins, buttons.green.pin, 5);
	btn_func_handle("Blue", dev, pins, buttons.blue.pin, 6);
}
